...
func (sn *SocialNetwork) UpdatePersonality(agentID commons.ID, extraStrategyScore float32, extraGoodwillScore float32) {
	agentProfile := sn.AgentProfile[agentID]
	agentProfile.Trusts.StrategyScore += extraStrategyScore
